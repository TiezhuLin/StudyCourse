		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="navbar-header">
				...
				<h1 class="navbar-brand">
					<a href="index.html">StudyCourse</a>
				</h1>
			</div>
			<!--navbar-header-->
		...
		<div class="header-info">
						...
						<c:choose>
							...
							<c:otherwise>
								<form id="nologin">
									...
									<p>
										<a class="sign" href="register">新用户注册</a> <span><a
											href="javascript:$('#myModal').modal('show')">忘记密码</a></span>
									</p>
								</form>
							</c:otherwise>
						</c:choose>
			...
			<div class="header-right cart">
				...
				<div class="cart-box">
					<h4>
						<a onclick="forwardCart('${sessionScope.username}')"> ￥<span
							class="simpleCart_total"><c:if
									test="${!empty sessionScope.totalprice}">${sessionScope.totalprice}</c:if></span>
						</a>
					</h4>
					<p>
