...
$(function() {
	...
	$("#findPasswordNext").click(function() {
		...
		if ($("#findPasswordNext").html() == "完成") {// 找回密码第二步
...
var index = {
	...
	URL : {
		...
		changeDefaultAddress:function(){
			return "/StudyCourse/address/changeAddress";
		},
		deleteAddress:function(){
			return "/StudyCourse/address/deleteAddress"
		},
